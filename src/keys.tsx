export class Keys {
    ...
    static PAGE_CREATE_USER: string = "/JuegoEscritores/Crear-Usuario";
    static PAGE_TABLE_GAME: string = "/JuegoEscritores/Juego"
    static PAGE_INPUT_SCORE: string = "/JuegoEscritores/Guardar-Puntaje"
    //Types games
